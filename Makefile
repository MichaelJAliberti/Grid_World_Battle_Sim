...
GameCommand.o: GameCommand.cpp GameCommand.h Model.h GameObject.h Pokemon.h PokemonGym.h PokemonCenter.h View.h Rival.h BattleArena.h
	$(CC) -c GameCommand.cpp -o GameCommand.o

BattleArena.o: BattleArena.cpp BattleArena.h GameObject.h Building.h Point2D.h
	$(CC) -c BattleArena.cpp -o BattleArena.o

Rival.o: Rival.cpp Rival.h BattleArena.h GameObject.h Point2D.h
	$(CC) -c Rival.cpp -o Rival.o

main.o: main.cpp Building.h Point2D.h Vector2D.h GameCommand.h PokemonCenter.h Model.h Pokemon.h PokemonGym.h GameObject.h View.h BattleArena.h Input_Handling.h
	$(CC) -c main.cpp
